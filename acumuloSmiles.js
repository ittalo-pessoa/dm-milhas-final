...
const usoMilhas = isNaN(parseFloat(document.getElementById('usoDasMilhas2').value.replace(/\./g, ""))) ? 0 : parseFloat(document.getElementById('usoDasMilhas2').value.replace(/\./g, ""));
if (
